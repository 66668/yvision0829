 ...
 */
public class DoorAccessInfoActivity extends BaseActivity {
    //back
    ...
    //公司
    @ViewInject(id = R.id.tv_CompanyName)
    ...
    //变量
    private DoorAccessModel model = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_door_detail_info);
    ...
    private void initMyView() {
        ...
        tv_title.setText(getResources().getString(R.string.text_door_title));
        tv_right.setText("");
        //图片缓存设置
    ...
    private void getDate() {
        ...
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    DoorAccessModel model = UserHelper.getDoorAccessDetail(DoorAccessInfoActivity.this, attendId);
    ...
    protected void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case GET_DATA_SUCCESS:
                model = (DoorAccessModel) msg.obj;
                setShow(model);
                break;
        }
    }

    private void setShow(DoorAccessModel model) {

        tv_name.setText(model.getEmployeeName());
        tv_workid.setText(model.getWrokId());
