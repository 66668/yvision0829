...
public class AttendInfoActivity extends BaseActivity {
    ...
    private void setShow(AttendModel model) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_attend_detail_info);
    ...
    private void initMyView() {
        ...
        tv_title.setText(getResources().getString(R.string.attendTile_detail));
        tv_right.setText("");
        //图片缓存设置
    ...
    private void getDate() {
        ...
        Loading.run(this, new Runnable() {
            ...
            public void run() {
                try {
                    AttendModel model = UserHelper.getAttendDetail(AttendInfoActivity.this, attendId);
