...
import com.yvision.adapter.DoorAccessListAdapter;
...
public class MainDoorAccessActivity extends BaseActivity implements RefreshAndLoadListView.IReflashListener, RefreshAndLoadListView.ILoadMoreListener {
    ...
    private void initListener() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                DoorAccessModel model = (DoorAccessModel) adapter.getItem(newPosition);

                Bundle bundle = new Bundle();
                bundle.putString("AttendID", model.getAccessRecordID());
                startActivity(DoorAccessInfoActivity.class, bundle);
            }
        });
    ...
    protected void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case LOADMORE_SUCCESS:
                //具体展示数据
                showLiseDate((ArrayList<DoorAccessModel>) msg.obj, LOADMORE_SUCCESS, null);
                break;
            case POST_FAILED:
    ...
    public void setIMaxTime(List<DoorAccessModel> list) {
        Log.d("SJY", "list size= " + list.size());
        IMaxtime = list.get(0).getCapTime();
    }

    public void setIMinTime(ArrayList<DoorAccessModel> list) {
        IMinTime = list.get(list.size() - 1).getCapTime();
    }

    //具体展示处理
    private void showLiseDate(ArrayList<DoorAccessModel> listdate, int key, String message) {
